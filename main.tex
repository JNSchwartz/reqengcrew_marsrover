...
Első a váll, amely minden irányban mozgatható egy megadott tartományban. (\reqid{R_1}) Ezt követi a könyök, amely hajlítható és egy 360 fokban elforgatható csukló. (\reqid{R_2}) Ennek a végén található egy fogó, mely cserélhető. 
Az egyik fajta fogó az expedíciókon használatos eszköz, melynek egyik ága a fúró, a másik pedig egy kamera, amely a fúrást segíti.  Ehhez egy lámpa is tartozik, ami normál fénytartományban működik.(\reqid{R_3})
A másik cserélhető fogó funkcióját tekintve (a jármű tetején lévő tárolóba való) rakodásra alkamlas. Ennek a fogónak az ágai egy síkon mozgathatóak. (\reqid{R_4}) Emellett található a karon egy biztonsági kontaktszenzor, amely véd a berendezés meghibásodása ellen. (\reqid{R_5})
...
\begin{itemize}
    \item \reqid{M_1} Kerék: 
        \begin{itemize}
            \item \reqid{M_1_1} Levegőmentes kerék
            \item \reqid{M_1_2} Alumíniumból kell készíteni
            \item \reqid{M_1_3} A tapadás érdekében kapcsokkal kell rendelkeznie
            \item \reqid{M_1_4} A rugós tapadásért titánium külőket kell bele építeni
        \end{itemize}
    \item \reqid{M_2} Futómű:
        \begin{itemize}
            \item \reqid{M_2_1} Rugalmas fémrács
            \item \reqid{M_2_2} Teherbírás -- jármű teherbírásának összetevői
                \begin{itemize}
                    \item jármű tömege
    ...
    \item \reqid{M_3} Motor:
        \begin{itemize}
            \item \reqid{M_3_1} Hidrogénmotor
            \item \reqid{M_3_2} Bázistól feltöltéskor vizet és energiát kapunk, a vizet a kapott energia segítségével kell oxigénre és hidrogénre bontani
            \item \reqid{M_3_3} A motor belsejében a hidrogént az oxigén segítségével elégetjük, a felszabaduló energiát használja a motor meghajtásra, a melléktermék vizet meg emberi fogyasztásra alkalmazható
        \end{itemize}
    \item \reqid{M_4} Tank:
        \begin{itemize}
            \item \reqid{M_4_1} Méretének akkorának kell, hogy 200 km üzemanyag elférjen benne
            \item \reqid{M_4_2} Két azonos méretű üzemanyag cellából álljon
            \item \reqid{M_4_3} A két üzemanyag cellából párhuzamosan fogyasszon üzemanyagot
            \item \reqid{M_4_4} Az üzemanyag cellák legyenek képesek önállóan is ellátni az eszközt
            \item \reqid{M_4_5} Feltölthető legyen a bázisról
            \item \reqid{M_4_6} Legyen egy rendszer ami méri a tank az üzemanyagcellák töltöttségét
            \item \reqid{M_4_7} Ez a rendszer értesítse a vezetőt, amikor a tank töltöttség félig van
            \item \reqid{M_4_8} Az üzemanyagcellák dokkolva tölthetőnek kell lenniük
        \end{itemize}
    \item \reqid{M_5} Közlekedés:
        \begin{itemize}
            \item \reqid{M_5_1} El kell érnie a  25 km/h sebességet
            \item \reqid{M_5_2} Képesnek kell lennie 20 nap alatt 20 km-t megtenni
            \item \reqid{M_5_3} A bevehető meredekségének 20-30-osnak kell lennie
            \item \reqid{M_5_4} A járműnek képesnek kell lennie oldalazva közlekedni
        \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item (\reqid{KO_12}) részecskeszűrő homokvohar
\end{itemize}

egyéb:
\begin{itemize}
    \item (\reqid{KO_12}) részecskeszűrő légkeringető homokvihar esetén (HEPA filter)
    \item (\reqid{KO_13}) a légkeringető szagtalanít is az összes szobában
\end{itemize}
