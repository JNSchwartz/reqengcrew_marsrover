...
A marsjárók képesek egymással kommunikálni illetve a bázissal, űrállomással is (az ellátmányhajóval való kommunikációs kapcsolat szükségtelen).  Ez a kommunikációs csatorna élő hang és videó kapcsolat létrehozására is képes. Ezt a járműben elhelyezett képernyő és kamera is biztosítja. Minimális, pár másodperces késés elfogadható a kommunikáció során.
...
\end{itemize}
A bejáratot egy vezérlőpult irányítja. A zsilip kamrájában egyszerre két ember tartózkodhat. A kamra a marsi levegő szűrésén kívűl fertötlenítést is végez.
