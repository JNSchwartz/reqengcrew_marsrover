...
Az egyik fajta fogó az expedíciókon használatos eszköz, melynek egyik ága a fúró, a másik pedig egy kamera, amely a fúrást segíti.  Ehhez egy lámpa is tartozik, ami normál fénytartományban működik.
A másik cserélhető fogó funkcióját tekintve (a jármű tetején lévő tárolóba való) rakodásra alkamlas. Ennek a fogónak az ágai egy síkon mozgathatóak.  (\reqid{R_3}) Emellett található a karon egy biztonsági kontaktszenzor, amely véd a berendezés meghibásodása ellen. (\reqid{R_4})
